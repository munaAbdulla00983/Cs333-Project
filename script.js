...
var code="";
    ...
    document.getElementById('deleteByCid').addEventListener('click',async function(event) {
      ...
      if(code!="")
      {
        if (confirm("Are you sure you want to delete this item?")) 
        {
          ...
          const response = await fetch('delete_study_group.php', {
            method: 'POST',
            headers: {
    ...
    async function fetchStudyGroupsByCid(cid){
      ...
      const response = await fetch('get_study_group_cid.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    async function searchData(){
      ...
      const response = await fetch('get_study_group_filter.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    document.getElementById('studyGroupForm').addEventListener('submit', async function(event) {
      ...
      const response = await fetch('insert_study_group.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    async function fetchStudyGroups() {
      try {
         const response = await fetch('get_study_group.php');
        studyGroups = await response.json();
        
        renderPage();

        const response1 = await fetch('get_comment.php');
